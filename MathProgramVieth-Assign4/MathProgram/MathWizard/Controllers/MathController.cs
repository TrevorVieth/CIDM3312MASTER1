            ...
            else
            {
                switch(mathOperation.Operator){
                    ...
                    case "Round":
                        ...
                        (float)Math.Round(mathOperation.LeftOperand, 0) ;                
                        break;

                    case "Floor":
                        mathOperation.Result = 
                        (float)Math.Floor(mathOperation.LeftOperand);                
                        break;

                    case "Ceiling":
                        mathOperation.Result = 
                        (float)Math.Ceiling(mathOperation.LeftOperand);                
                        break; 
                ...
                switch(mathOp.Operator){
                    ...
                    */
                    ...
                    case "Round":
                        ...
                        (float)Math.Round(mathOp.LeftOperand, 0) ;                
                        break;

                    case "Floor":
                        mathOp.Result = 
                        (float)Math.Floor(mathOp.LeftOperand);                
                        break;

                    case "Ceiling":
                        mathOp.Result = 
                        (float)Math.Ceiling(mathOp.LeftOperand);                
                        break; 
